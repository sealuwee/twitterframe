'''
    This script is going to house all of the colors for the command line.
    I really shouldn't be making this so early into creating the application because some of the
    basic functionality doesn't even work yet, but you know what...
    I really like colors in my terminal...
'''
